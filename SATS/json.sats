...
(jsonval,jsonval)
typedef json_arg3 =
(jsonval,jsonval,jsonval)
typedef json_arg4 =
(jsonval,jsonval,jsonval,jsonval)
typedef json_arg5 =
(jsonval,jsonval,jsonval,jsonval,jsonval)
typedef json_arg6 =
(jsonval,jsonval,jsonval,jsonval,jsonval,jsonval)
typedef json_arg7 =
(jsonval,jsonval,jsonval,jsonval,jsonval,jsonval,jsonval)
typedef json_arg8 =
(jsonval,jsonval,jsonval,jsonval,jsonval,jsonval,jsonval,jsonval)
typedef json_arg9 =
(jsonval,jsonval,jsonval,jsonval,jsonval,jsonval,jsonval,jsonval,jsonval)
typedef json_arg10 =
(jsonval,jsonval,jsonval,jsonval,jsonval,jsonval,jsonval,jsonval,jsonval,jsonval)

fun
jsonify0 (guard_name: string): jsonval
fun
jsonify1 (guard_name: string, arg_name: string, arg_json: jsonval): jsonval
fun
jsonify2 (guard_name: string, arg_names: str_arg2, arg_json: json_arg2): jsonval
fun
jsonify3 (guard_name: string, arg_names: str_arg3, arg_json: json_arg3): jsonval
fun
jsonify4 (guard_name: string, arg_names: str_arg4, arg_json: json_arg4): jsonval
fun
jsonify5 (guard_name: string, arg_names: str_arg5, arg_json: json_arg5): jsonval
fun
jsonify6 (guard_name: string, arg_names: str_arg6, arg_json: json_arg6): jsonval
fun
jsonify7 (guard_name: string, arg_names: str_arg7, arg_json: json_arg7): jsonval
fun
jsonify8 (guard_name: string, arg_names: str_arg8, arg_json: json_arg8): jsonval
fun
jsonify9 (guard_name: string, arg_names: str_arg9, arg_json: json_arg9): jsonval
fun
jsonify10 (guard_name: string, arg_names: str_arg10, arg_json: json_arg10): jsonval
